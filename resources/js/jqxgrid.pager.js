    ...
    a.extend(a.jqx._jqxGrid.prototype, {
        _initpager: function() {
            ...
            if (!this.pagerrenderer) {
                ...
                this.pagergotoinput = this.pagergotoinput || a('<div style="margin-right: 7px; width: 27px; height: 17px; float: right;"><input style="margin-top: 0px; text-align: left; width: 27px;" type="text"/></div>');
