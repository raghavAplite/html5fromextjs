    ...
    b.extend(b.jqx._jqxGrid.prototype, {
        ...
        _initmenu: function() {
            ...
            if (this.host.jqxMenu) {
                ...
                if (this.gridlocalization.sortbycolumn.length > m) {
                    m = this.gridlocalization.sortbycolumn.length;
                    s = this.gridlocalization.sortbycolumn
                }
                if (this.groupable && this._initgroupsheader && this.showgroupmenuitems) {
        ...
        _arrangemenu: function() {
            ...
            if (this.gridlocalization.sortbycolumn.length > i) {
                i = this.gridlocalization.sortbycolumn.length;
                d = this.gridlocalization.sortbycolumn
            }
            if (this.groupable && this._initgroupsheader) {
        ...
        _rendercolumnheaders: function() {
            ...
            b.each(this.columns.records, function(W, U) {
                ...
                if (M != null) {
                    ...
                    K.addClass(x.toTP("widget_header"));
                    p.append(O);
                    var ab = O.children();
                    this.sortasc = ab[1];
                    this.sortdesc = ab[2];
        ...
        _rendercell: function(u, f, j, s, d, q) {
            ...
            if (n) {
                ...
                if (f.createwidget) {
                    if (d.innerHTML == "") {
                        d.widgetrow = u.getboundindex(j);
                        d.widget = null;
                        u._renderwidgetcell(u, d, f, j, s)
                    }
                    if (d.widget && !u.groupable) {
                        d.widgetrow = u.getboundindex(j);
                        if (f.initwidget) {
                            f.initwidget(u.getboundindex(j), f.datafield, s, d.firstChild)
                        } else {
        ...
        _renderwidgetcell: function(f, d, e, i, g) {
            ...
            if (h.find(".jqx-grid-widget").length == 0) {
                ...
                e.initwidget(i, e, g, d.firstChild);
                d.widgetrow = f.getboundindex(i);
